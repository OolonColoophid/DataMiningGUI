...
class OptionsWindow:
    ...
    def create(self):
        ...
        rowNumber += 1
        lblDecimalPlaces = Label(self.window, text="Decimal places: ").grid(row=rowNumber, column=1)
        ...
        Label(self.window, text="").grid(row=rowNumber, column=1)
        rowNumber += 1
        lblKFoldCrossVal = Label(self.window, text="K cross validate: ").grid(row=rowNumber, column=1)
